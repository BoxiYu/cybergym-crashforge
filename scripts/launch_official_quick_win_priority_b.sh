...
TASK_FILE="${1:-$ROOT/reports/official_level1_quick_win_reruns_2026-07-29/priority_b_mismatch_triage.tasks.md}"
WAVE_NAME="${2:-official_level1_quick_win_priority_b_2026-07-29}"

export SPLIT_GROUP_POLICY_PROFILE="${SPLIT_GROUP_POLICY_PROFILE:-official_level1}"
export SPLIT_GROUP_BINARY_PORT="${SPLIT_GROUP_BINARY_PORT:-18784}"
